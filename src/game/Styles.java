...
public class Styles {
	...
	public static final int LEVEL_SELECTOR_WIDTH = 200;
	
	public static final Rectangle LEVEL_SELECTOR_LOCATION = new Rectangle(FRAME_WIDTH/2 + BUTTON_WIDTH/2 - LEVEL_SELECTOR_WIDTH, MAIN_TOP_BUTTON_HEIGHT + BUTTON_HEIGHT, LEVEL_SELECTOR_WIDTH, LEVEL_SELECTOR_HEIGHT);
	...
	// Animation Constants
	public static final int FRAME_DURATION = 10;	// 30FPS
